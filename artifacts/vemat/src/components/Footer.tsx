          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                aria-label="LinkedIn Vemat Group"
                className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-accent hover:text-white hover:border-accent transition-all duration-300"
              >
