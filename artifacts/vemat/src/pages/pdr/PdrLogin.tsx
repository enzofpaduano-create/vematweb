...
export default function PdrLogin() {
  const [, navigate] = useLocation();
  const { signIn } = usePdrAuth();
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full bg-zinc-900 border border-zinc-700 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-sky-500 placeholder:text-zinc-600 transition-colors pr-12"
              />
              <button
                type="button"
