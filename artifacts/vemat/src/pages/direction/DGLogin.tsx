    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 bg-purple-500/10 text-purple-400 text-xs font-black uppercase tracking-widest px-3 py-1.5 rounded-full mb-4">
            <TrendingUp className="w-3 h-3" />
            Espace Direction
          </div>
          <h1 className="text-2xl font-black text-white">Connexion</h1>
          <p className="text-zinc-500 text-sm mt-1">Accès réservé à la direction</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              autoFocus
              placeholder="dg@vemat.ma"
              className="w-full bg-zinc-900 border border-zinc-700 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-purple-500 placeholder:text-zinc-600 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full bg-zinc-900 border border-zinc-700 text-white rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:border-purple-500 placeholder:text-zinc-600 transition-colors"
              />
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-purple-600 hover:bg-purple-500 text-white font-black py-3 rounded-xl transition-colors disabled:opacity-60 mt-2">
