      ...
      <div className="p-6 lg:p-10 max-w-[1400px] mx-auto bg-zinc-50 min-h-screen">
        <div className="mb-8">
          ...
          <p className="text-zinc-500 text-sm max-w-2xl">
            {lang === "fr"
              ? "Catalogues de pièces détachées Terex Crespellano — pour identifier les références lors de tes interventions."
              : "Terex Crespellano spare parts catalogues — to identify part numbers during your interventions."}
          </p>
        ...
        {machines !== null && machines.length > 0 && (
          <div className="relative mb-6 max-w-md">
            ...
            <input
              ...
              className="w-full pl-9 pr-9 py-2.5 bg-white border border-zinc-200 rounded-xl text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-colors"
            />
            {query && (
              <button
                type="button"
